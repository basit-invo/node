...
var responseStatus_1 = __importDefault(require("../utils/responseStatus"));
var models_1 = __importDefault(require("../models"));
var User = models_1.default.user;
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, UserDataExist, UserData, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_1 = _a.sent();
                defaultResponse_1.default.error({ message: err_1 }, res, responseStatus_1.default.ERROR);
                return [3 /*break*/, 4];
